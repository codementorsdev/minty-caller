...
import { CallsEvent, CallType, PeerConnectionState, SessionConnectionState } from '../types/calls';
...
export default class WebRTCClient {
    ...
    SessionConnectionState: typeof SessionConnectionState;
    ...
    addListener(name: CallsEvent, listener: Calls.Listeners): () => void;
    removeListener(name: CallsEvent): void;
