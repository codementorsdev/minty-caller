...
export declare namespace ConnectyCubeChat {
    ...
    type ConnectionStatus = 'online' | 'offline' | 'connecting' | 'connect' | 'opening' | 'open' | 'closing' | 'close' | 'disconnecting' | 'disconnect';
    type MessageParams = {
        id?: string;
    ...
    type OnChatConnectionErrorListener = () => void;
    ...
    type OnMessageSentListener = (lost: object | null, sent?: object) => void;
    type OnLastUserActivityListener = (userId: LastActivity['userId'], seconds: LastActivity['seconds']) => void;
    type OnRosterSubscribeListener = (userId: number) => void;
    type OnRosterConfirmListener = (userId: number) => void;
    type OnRosterRejectListener = (userId: number) => void;
    type OnRosterListListener = (userId: number, type: string) => void;
    ...
    type ContactListSubscriptionPresence = {
        jid: string;
        type: string;
    };
    type PrivacyList = {
