...
export default class ChatService {
    ...
    onSubscribeListener: Chat.OnRosterSubscribeListener;
    onConfirmSubscribeListener: Chat.OnRosterConfirmListener;
    onRejectSubscribeListener: Chat.OnRosterRejectListener;
    onContactListListener: Chat.OnRosterListListener;
     ...
     */
    getContacts(): Promise<Chat.ContactList>;
    ping(): Promise<void>;
    ...
    private get isStreamManagementSupported();
