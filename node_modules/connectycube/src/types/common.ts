export type Timestamp = number; // seconds (e.g. "Date.now() / 1000")
...
export type SearchCondition<T> = T | { [key in SearchOperator]?: T | T[] } | { [key: string]: SearchCondition<T> };
export type EmptyParams = {} | undefined;
export type EmptyResponse = void | null | undefined | '' | ' ' | 'empty body';
export type ForceParams = { force?: number | string } | undefined;
